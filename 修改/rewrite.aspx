<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rewrite.aspx.cs" Inherits="增加_t1" %>
...
<body>
    ...
    <div>
        ...
        <table bgcolor="#FFCC00" class="style1">
            <tr>
                <td class="style2" style="border: thin solid #FFFFFF;">
            ...
            <tr>
                <td style="border: thin solid #FFFFFF;">
                    <asp:GridView ID="GridView1" runat="server" align="center" AllowPaging="True" 
                        ...
                        DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" PageSize="2" OnSelectedIndexChanged="GridView1_SelectedIndexChanged1">
                    ...
                    <asp:DetailsView ID="DetailsView1" runat="server"  align="center"  AutoGenerateRows="False" 
